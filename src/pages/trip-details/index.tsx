import { Calendar, CircleCheckIcon, CircleDashed, Link2, MapPin, Plus, Settings2, UserCog } from "lucide-react";
        ...
        <div className="max-w-6xl px-6 py-10 mx-auto space-y-8">
            <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-shape flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg text-zinc-100">Barueri, Brasil</span>
                </div>
            ...
            <main className="flex gap-16 px-4">
                ...
                <div className="w-80 space-y-6">
                    <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">
                                        https://www.airbnb.com.br/rooms/1847882222222222811
                                    </a>
                                </div>
                        ...
                        <button
                            className="bg-zinc-800 text-zinc-300 rounded-lg w-full justify-center h-11 font-medium flex items-center gap-2 hover:bg-zinc-700">
                            <Plus className="size-5" />
                            Cadastrar novo link
                        </button>
                    </div>
