    ...
    return (
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3"  >
            <div className="flex items-center gap-2 flex-1">
                ...
                onChange={event => setDestination(event.target.value)} // Valor em tempo real do input: toda vez que o input mudar, a função será chamada, esclarecendo que se trata da função que altera o valor da variável do useState
                />
            </div>
